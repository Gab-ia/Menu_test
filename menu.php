...
<html lang="en">
    ...
    <body>
        ...
        <div class="menuRang margin-top">
            ...
            <p class="text-align menuTitle green">Menu du jour</p>
            
            <p class="text-align menuTitle green">Entrée - Plat</p>

            <p class="text-align menuTitle green">Plat - Dessert</p>

        </div>

        <div class="menuRang menuRang2">
            
            <div class="col-md-3 text-align">

                <img src="../img/icones/entree.svg" class="menuImgSize">

                <img src="../img/icones/plat.svg" class="menuImgSize">

                <img src="../img/icones/dessert.svg" class="menuImgSize">
        ...
        <h2 class="text-align menuTitle green margin-top">Les suppléments</h2>
            ...
            <div class="text-align margin-bottom">
                ...
                <img src="../img/icones/soupe.svg" class="menuImgSize">
                <img src="../img/icones/pain.svg" class="menuImgSize">
            </div>

        <p class="text-align margin-bottom">Pour compléter votre déjeuner ou servir de base à votre dîner, nous pouvons ajouter à votre repas des suppléments au choix : une portion de fromage, la soupe du jour, une demi-baguette.</p>

        <h4 class="text-align blue margin-top-bottom">Chaque semaine, vous pouvez retrouver le détail des menus proposés sur la page Facebook de Menu Portage.</h4>
