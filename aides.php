       ...
       <?php include 'php/navbar.php'; ?>
        ...
        <!-- Main -Gabi- -->
         <div class="equipe_description section-header booking"> 
            <h2 class="text-align">La facturation et les aides</h2>
            <p class="text-align">Tous les détails sur la facturation des repas livrés à domicile, ainsi que les aides possibles : APA, caisses de retraite, mutuelles, etc. 
            </p>
        </div>   
